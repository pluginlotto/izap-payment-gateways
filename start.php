...
function izap_payments_init() {
  ...
  if (elgg_get_plugin_setting('global_payment_gateway') == 'no') {
  ...
  $IZAP_PAYMENT_GATEWAYS->custom = array(
      'installed_gateways' => array(
          'multi' => array('paypal' => 'paypal', 'alertpay' => 'alertpay'),
          'single' => array('payleap' => 'payleap', 'authorize' => 'authorize', 'none' => 'none'),
      ),
      'installed_gateways' => array(
